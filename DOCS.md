...
*최종 업데이트: 2026-03-19 — sparkline 컬럼 타입에 `sparklineType` 옵션 추가 (`'line' | 'area' | 'bar' | 'column'`, 기본값 `'line'`): line(polyline), area(polygon), bar(수평 rect), column(수직 rect) 4종 차트 스타일 지원.*
